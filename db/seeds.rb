...
projects = [{:name => 'Project A', :location => 'Alabama', :category => 'education', :organization => 'org A', :blurb => 'sample blurb', :nonprofit_mission => 'sample mission', :description => 'sample description', :deadline => '30-Oct-2013', :status => 'open', :budget => '2000'},
      ...
      {:name => 'Project D', :location => 'Delaware', :category => 'community', :organization => 'org C', :blurb => 'blurb C', :nonprofit_mission => 'goals for C', :description => 'stuffs for D', :deadline => '06-Nov-2013', :status => 'pending', :budget => '1000'},
      {:name => 'Project E', :location => 'Florida', :category => 'education', :organization => 'org C', :blurb => 'blurb C', :nonprofit_mission => 'goals for C', :description => 'stuffs for E', :deadline => '06-Nov-2013', :status => 'pending', :budget => '1000'},
      {:name => 'Project F', :location => 'Florida',:category => 'housing', :organization => 'org C', :blurb => 'blurb C', :nonprofit_mission => 'goals for C', :description => 'stuffs for F', :deadline => '06-Nov-2013', :status => 'pending', :budget => '1000'}]
