Feature: Filter Projects
 ...
 Background: Add projects to database
        ...
        | Project B   | Housing		| California	| org B        | new blurb           | free mission              | to describe               | 31-Dec-2013            | open          | 5000      |
        | Project C   | Community	| California	| org C        | blurb C             | goals for C               | stuffs for C              | 31-Jan-2014            | pending       | 1000      |
        | Project D   | Community	| Delaware	| org D        | blurb D        | goals for D            | stuffs for D        | 31-Jan-2013            | pending          | 1000      |
        | Project E   | Education	| Florida	| org E        | blurb E           | goals for E              | stuffs for E               | 28-Feb-2014            | pending          | 3500      |
        | Project F   | Community	| California	| org F        | blurb F             | goals for F               | stuffs for F              | 30-Apr-2013            | pending       | 1000      |
